  ...
  const sections = [
    {
      ...
      paragraphs: [
        'Web3 payments still feel like a cash-only economy: every interaction must be prefunded, assets sit idle, and settlement latency erodes UX. 4Mica changes that by introducing a cryptographic payment tab&mdash;a non-custodial line of credit that lets users consume services instantly while settlement happens later. Collateral lives in yield-bearing vaults, operators issue guarantees within milliseconds, and service providers (the &ldquo;lenders&rdquo;) receive fair-exchange promises they can redeem on-chain if a user walks away. The result is Visa-like speed backed by immutable settlement.',
    ...
    },
    {
      ...
      paragraphs: [
        'The protocol&rsquo;s security target is simple: if 4Mica issued a guarantee, the recipient must be able to get paid. Achieving that requires several layers working together:',
      ],
      bullets: [
        'Operator honesty: 4Mica inherits Ethereum&rsquo;s restaked security. As long as two-thirds of operators are honest, adversaries cannot forge a valid aggregated signature.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Agentic marketplaces: autonomous agents often need to call APIs hundreds of times per session. 4Mica lets an agent present a guarantee, consume resources, and settle in batches&mdash;exactly the behaviour envisaged in standards like x402.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'In other words, 4Mica is the shopkeeper&rsquo;s tab rebuilt for blockchains. It turns moment-to-moment interactions into an instant, recoverable flow&mdash;fast enough for modern UX, secure enough for decentralised settlement, and flexible enough to integrate wherever builders need credit to unlock adoption.',
      ],
    },
  ];
